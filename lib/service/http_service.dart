...
class HttpClientService {
  ...
  static Future<Response> postMessage(String message) {
    ...
    dynamic data = { "message": message };
    return _dio.post("https://252e-50-47-216-241.ngrok-free.app/usermessage", options: options, data: jsonEncode(data));
  }
